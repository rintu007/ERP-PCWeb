...
<div class="wrapper">
  ...
  <div class="bills cf">
    <div class="con-header">
      ...
      <p id="identifier" class="cf tr" style="margin: 10px 0 0 0; "><label>单据编号:</label><span id="number"><?php echo str_no('XSBJ');?></span></p>
    </div>
    <div class="grid-wrap">
      <table id="grid">
      </table>
 ...
 <!--      </ul>
      <ul class="dn"> -->
        ...
        <li id="accountWrap" >
          ...
          <input type="text" class="input-txt" autocomplete="off">
          <i class="trigger"></i></span><a id="accountInfo" class="ui-icon ui-icon-folder-open" style="display:block;"></a>
        </li>
        <li class="dn">
          <label>本次欠款:</label>
...
<script src="<?php echo base_url()?>statics/js/dist/salesQuotation.js?ver=20171020"></script>
</body>
</html>