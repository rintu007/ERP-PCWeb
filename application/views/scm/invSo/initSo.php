...
<link href="<?php echo base_url()?>statics/css/<?php echo sys_skin()?>/bills.css?ver=201507241412" rel="stylesheet" type="text/css">
<style>
  ...
  <div class="bills cf">
    <div class="con-header">
      <dl class="cf">
        ...
        <dd id="identifier" class="pct15 tc dn">
          <label>销售人员:</label>
        ...
        <dd class="pct15 tc">
          <label>单据日期:</label>
          <input type="text" id="date" class="ui-input ui-datepicker-input" value="2015-07-27">
        </dd>
        <dd class="pct15 tc">
          <label>交货周期:</label>
          <input type="text" id="deliveryDate" class="ui-input" style="width:30px;margin-right:5px;" value="30">
          天
        </dd>
          <dd class="pct15">
              <label>币种:</label>
              <span class="ui-combo-wrap" id="currency">
              <input type="text" class="input-txt" autocomplete="off">
          <i class="trigger"></i></span>
          </dd>
          <dd id="identifier" class="pct20 tr">
              <label>单据编号:</label>
              <span id="number"><?php echo str_no('XSDD')?></span></dd>
      </dl>
        <dl class="cf" style="margin-top:10px;">

          <dd class="pct20">
              <label>支付方式:</label>
              <span class="ui-combo-wrap" id="payment">
              <input type="text" class="input-txt" autocomplete="off">
          <i class="trigger"></i></span>
          </dd>
          <dd class="pct15">
              <label>交货方式:</label>
              <span class="ui-combo-wrap" id="shipping">
              <input type="text" class="input-txt" autocomplete="off">
          <i class="trigger"></i></span>
          </dd>
            <dd id="accountWrap" class="pct25">
                <label>结算账户:</label>
                <span class="ui-combo-wrap" id="account" style="padding:0;">
          <input type="text" class="input-txt" autocomplete="off">
          <i class="trigger"></i></span></dd>
        <dd id="classes" class="pct15 tr dn">
          <label class="radio">
...
<script src="<?php echo base_url()?>statics/js/dist/salesOrder.js?v=20171104"></script>
</body>
</html>