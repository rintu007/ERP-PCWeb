...
<head>
<title><?php echo $transType==150701 ? '采购入库单' :'采购退货单'?></title>
...
<table class="list" align="center">
			<thead>
				...
				<th width="30" align="center">单据日期</th>
				    ...
				    <th width="30" align="center">业务类别</th>
					<th width="60" align="center">供应商</th>
...
<!-- 					<th width="80" align="center">折后金额</th> -->
					<th width="30" align="center">本次付款</th>
					<th width="30" align="center">本次欠款</th>
