		...
		<table width="1500px" class="list"  border="1">
			<thead>
				<tr>
				    ...
				    <th width="50" align="center">业务类别</th>
					<th width="80" align="center">客户</th>
...
<!-- 					<th width="60" align="center">折后金额</th> -->
					<th width="50" align="center">本次收款</th>
					<th width="50" align="center">本次欠款</th>
				    <th width="50" align="center">制单人</th>
					<th width="50" >审核人</th>
					...
					<th width="50" align="center">销售单价</th>	
	...
	<!-- 				<th width="100" align="center">源单号</th>  -->
		...
		<!-- 			<td rowspan="<?php echo $n?>" ><?php echo $row['totalAmount']?></td>
				...
				?>
					...
					<td   style="border-left:0px;"><?php echo $row1['invNumber'].' '.$row1['invName'].' '.$row1['invSpec']?></td>
