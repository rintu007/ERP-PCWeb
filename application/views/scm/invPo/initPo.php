...
<link href="<?php echo base_url()?>/statics/css/<?php echo sys_skin()?>/bills.css?ver=20140430" rel="stylesheet" type="text/css">
<style>
    ...
    <div class="bills cf">
        <div class="con-header">
          ...
          <i class="ui-icon-ellipsis"></i></span></dd>
                <dd class="pct20">
                    <label>收货仓库:</label>
                    <span class="ui-combo-wrap" id="storage">
          ...
          <i class="trigger"></i></span>
                ...
                <dd class="pct20">
                    <label>单据日期:</label>
                    <input type="text" id="date" class="ui-input ui-datepicker-input" value="2015-04-27">
                </dd>
                <dd class="pct20">
                    <label>交货日期:</label>
                    <input type="text" id="deliveryDate" class="ui-input ui-datepicker-input" value="2015-04-27">
                </dd>
            </dl>
          ...
          <i class="trigger"></i></span>
                ...
                <dd id="accountWrap"  class="pct30">
                    <label>结算账户:</label>
                    <span class="ui-combo-wrap" id="account" style="padding:0;">
          <input type="text" class="input-txt" autocomplete="off">
          <i class="trigger"></i></span>
                </dd>
                <dd id="identifier" class="pct20">
                    <label>单据编号:</label>
                    <span id="number"><?php echo str_no('PO')?></span></dd>
                <dd id="classes" class="pct15 tc dn">
                    <label class="radio">
...
<script src="<?php echo base_url()?>/statics/js/dist/purchaseOrder.js?ver=20171029"></script>
</body>
</html>