       ...
       -->
		<table width="100%" border="0" cellspacing="0" cellpadding="20">
		  <tr>
		    ...
		    <td><a class="ta t6" tabid="report-salesProfit" data-right="SAREPORTINV_QUERY" tabTxt="销售利润表" parentOpen="true" rel="pageTab" href="<?php echo site_url('report/salesProfit?action=detail')?>">销售利润表</a></td>  
		  </tr>
		</table>
      </div>
      <ul class="quick-links">
        <li class="purchase-purchase">
        	<a tabid="purchase-purchase" data-right="PU_ADD" tabTxt="采购入库单" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invPu?action=initPur')?>"><span></span>采购入库</a>
        </li>
        <li class="sales-sales">
        	<a tabid="sales-sales" data-right="SA_ADD" tabTxt="销售出库单" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invSd?action=initSale')?>"><span></span>销售出库</a>
        </li>
 ...
 <!--      <li class="added-service">
  ...
  <div class="col-extra">
    <div class="extra-wrap">
      ...
      <div class="list">
        <ul>
            <li><!--<span class="bulk-import">导入</span>--><a tabid="setting-goodsList" data-right="INVENTORY_QUERY" tabTxt="商品管理" parentOpen="true" rel="pageTab" href="<?php echo site_url('settings/goods_list')?>">商品管理</a></li>
            <li><!--<span class="bulk-import">导入</span>--><a tabid="setting-customerList" data-right="BU_QUERY" tabTxt="客户管理" parentOpen="true" rel="pageTab" href="<?php echo site_url('settings/customer_list')?>">客户管理</a></li>
            <li><!--<span class="bulk-import">导入</span>--><a tabid="setting-vendorList" data-right="PUR_QUERY" tabTxt="供应商管理" parentOpen="true" rel="pageTab" href="<?php echo site_url('settings/vendor_list')?>">供应商管理</a></li>
            <li><a tabid="sales-salesList" data-right="SA_QUERY" tabTxt="销售记录" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invSd?action=initSaleList')?>">销售记录</a></li>
            <li><a tabid="purchase-salesList" data-right="PU_QUERY" tabTxt="采购记录" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invPu?action=initPurList')?>">采购记录</a></li>
        	<li><a href="<?php echo site_url('scm/receipt?action=initReceipt')?>" rel="pageTab" tabid="money-receiptList" tabTxt="收款记录" data-right="RECEIPT_QUERY" parentOpen="true">收款记录</a></li>
            <li><a href="<?php echo site_url('scm/payment?action=initPay')?>" rel="pageTab" tabid="money-paymentList" tabTxt="付款记录" data-right="PAYMENT_QUERY" parentOpen="true">付款记录</a></li>
        	<li><a href="<?php echo site_url('report/sales_detail')?>" rel="pageTab" tabid="report-salesDetail" tabTxt="销售明细表" data-right="SAREPORTDETAIL_QUERY" parentOpen="true">销售明细表</a></li>
            <li><a href="<?php echo site_url('report/pu_detail_new')?>" rel="pageTab" tabid="report-puDetail" tabTxt="采购明细表" data-right="PUREOORTDETAIL_QUERY" parentOpen="true">采购明细表</a></li>
        	<li style="border-bottom:none; line-height: 42px; "><a tabid="storage-transfersList" data-right="TF_QUERY" tabTxt="调拨记录" parentOpen="true" rel="pageTab" href="<?php echo site_url('scm/invTf?action=initTfList')?>">调拨记录</a></li>
        	<!--
