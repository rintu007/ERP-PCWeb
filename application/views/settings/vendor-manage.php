    	...
    	<form id="manage-form" action="">
    		<ul class="mod-form-rows base-form cf" id="base-form">
    			...
    			<li class="row-item">
    				...
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" style="width:185px;" name="taxRate" id="taxRate"><span>%</span></div>
    			</li>
    			<li class="row-item odd">
...
<script src="<?php echo base_url()?>/statics/js/dist/vendorManage.js?ver=20171014"></script>
</body>
</html>