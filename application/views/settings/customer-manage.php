...
.manage-wrapper{margin:20px auto 10px;width:800px;}
...
.manage-wrap textarea.ui-input{width: 790px;height: 60px;overflow:hidden;}
    ...
    <div id="manage-wrap" class="manage-wrap">
    	<form id="manage-form" action="">
    		<ul class="mod-form-rows base-form" id="base-form">
    			...
    			<li class="row-item">
    				<div class="label-wrap"><label for="taxnumber">税号</label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="taxnumber" id="taxnumber"></div>
    			</li>
    			<li class="row-item odd">
    				<div class="label-wrap"><label for="account">银行账号</label></div>
...
<script src="<?php echo base_url()?>statics/js/dist/customerManage.js?ver=20171004"></script>
</body>
</html>
