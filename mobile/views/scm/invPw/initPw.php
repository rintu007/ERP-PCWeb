...
<style>
#barCodeInsert{
margin-left: 10px;font-weight: 100;font-size: 12px;color: #fff;
  ...
  <div class="bills cf">
    <div class="con-header">
      <dl class="cf">
        <dd id="dd_orderid">
          <label>采购单编号:</label>
          <input type="text" name="orderid" id="orderid" class="ui-input" style="width:200px;" value="">
         </dd>
        <dd class="pct25 tc">
          <label>单据日期:</label>
        ...
        <dd id="identifier" class="pct25 tc">
          <label>单据编号:</label>
          <span id="number"><?php echo str_no('CGRK')?></span>
        </dd>     
      </dl>
    </div>
    <div class="grid-wrap">
...
<script src="<?php echo base_url()?>statics/js/dist/purchaseWarehouse.js?ver=20171010"></script>
</body>
</html>