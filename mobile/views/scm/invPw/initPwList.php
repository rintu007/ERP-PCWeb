...
<div class="wrapper">
  <div class="mod-search cf">
    ...
    <div class="fr"><a class="ui-btn ui-btn-sp" id="add">新增</a><a class="ui-btn" id="print" target="_blank" href="javascript:void(0);">打印</a><a class="ui-btn" id="export" target="_blank" href="javascript:void(0);">导出</a><a class="ui-btn dn" id="audit">审核</a><a class="ui-btn" id="reAudit">反审核</a></div>
  </div>
...
<script src="<?php echo base_url()?>statics/js/dist/purchaseWarehouseList.js?ver=20171013"></script>
</body>
</html>