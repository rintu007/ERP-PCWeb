...
<?php for($t=1; $t<=$countpage; $t++){?>
		<table  width="800"  align="center">
			...
			<tr height="15px">
				<td align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;height:25px;"><?php echo '销售出库单'?></td>
			</tr>
		</table>		
		
		<table width="1100" align="center">
			<tr height="15" align="left" >
				<td width="550" style="font-family:'宋体'; font-size:14px;height:20px;">采购方：<?php echo /*$contactNo.' '.*/$contactName?> </td>
				<td width="10" ></td>
...
<!-- 				<td width="60" >币别：RMB</td> --> 
		...
		<table width="1200" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">
				...
				<tr style="height:20px">
					...
					<td width="450" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">商品</td> 
					...
					<td width="60" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">销售数量</td>
					...
					<td width="80" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">出库数量</td>
			   ...
			   ?>
				<tr style="height:20px">
				   <td style="border:solid #000000;border-width:0 1px 1px 0;height:15px;font-family:'宋体'; font-size:12px;" align="center"><?php echo $row['i']?></td>
					...
					<td align="right"><?php echo str_money(abs($row['salesQty']),$system['qtyPlaces'])?></td>				
					<td ><?php echo $row['locationName']?></td>
					<td align="right"><?php echo $row['outingQty']?></td>
		...
		<table  width="800" align="center">
			<tr height="25" align="left">
				...
				<td width="250" style="font-family:'宋体'; font-size:14px;height:25px;">销售责任人签字：____________</td>
				<td width="250" style="font-family:'宋体'; font-size:14px;height:25px;">收货责任人签字：____________</td>
				<td width="100" ></td>
				<td width="100" ></td> 
			</tr>
		</table>	
