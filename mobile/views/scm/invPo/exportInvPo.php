...
<table width="1500px" class="list">
  			<tr><td class='H' align="center" colspan="19"><H3>采购订单记录<H3></td></tr>
  		</table>
		<table width="1500px" class="list"  border="1">
			<thead>
				<tr>
					...
					<th width="80" align="center">交货日期</th>
			...
			<tbody>
				...
				<tr target="id">
					...
					<td rowspan="<?php echo $n?>" ><?php echo intval($row['billStatus'])==2 ? '全部入库' :'未入库';?></td>
