...
<head>
    <title><?php echo $transType==150501 ? '采购订单' :'采购退货单'?></title>
...
<table width="800" align="center" style="position:absolute;left:0px;top:35px;">
    <tr height="15px">
        <td align="center" style="font-size:18px; font-weight:normal;height:25px;"><?php echo $transType==150501 ? '采购订单' :'采购退货单'?></td>
    </tr>
    <tr height="10px">
...
<table align="center" border="1" cellpadding="2" cellspacing="1"
    ...
    <tr height="16" align="left">
        <td width="70" align="center" style="background-color:LightGrey;">联系人</td>
        <td width="350"><?php echo $staffName ?></td>
        <td width="30" align="center" style="background-color:LightGrey;">手机</td>
    ...
    <tr height="16" align="left">
        <td width="70" align="center" style="background-color:LightGrey;">地址</td>
        <td width="350"><?php echo $system['companyAddr'] ?></td>
        <td width="30" align="center" style="background-color:LightGrey;">邮箱</td>
        <td colspan="3"><?php echo $staffEmail ?></td>
    </tr>
    <tr height="16" align="center">
        <td colspan="6" style="background-color:LightGrey;padding:4px 0 2px 0;">货物寄送地址</td>
    </tr>
    <tr>
        <td width="70" align="center" style="background-color:LightGrey;">仓库名称</td>
        <td width="385"><?php echo $storageName ?></td>
        <td colspan="2" align="center" style="background-color:LightGrey;">联系人</td>
        <td colspan="2"><?php echo $storageManager ?></td>
    </tr>
    <tr>
        <td width="70" align="center" style="background-color:LightGrey;">地址</td>
        <td width="385"><?php echo $storageAddress ?></td>
        <td colspan="2" align="center" style="background-color:LightGrey;">电话</td>
...
<table align="center" border="1" cellpadding="2" cellspacing="1"
    ...
    <tr>
        ...
        <td width="100"><?php echo $deliveryDate ?></td>
...
<table border="1" cellpadding="2" cellspacing="1" align="center"
    ...
    <tr style="background-color:LightGrey;">
        <td width="30" style="border:solid #000000;border-width:0 1px 1px 0;padding:5px 0 4px 0;" align="center">
            Line
        </td>
        <td width="60" style="border:solid #000000;border-width:0 1px 1px 0;" align="center">
            名称
        </td>
        <td width="90" style="border:solid #000000;border-width:0 1px 1px 0;" align="center">
            型号
        </td>
        <td width="70" style="border:solid #000000;border-width:0 1px 1px 0;" align="center">
            厂家
        </td>
        <td width="190" style="border:solid #000000;border-width:0 1px 1px 0;" align="center">
            描述
        </td>
        <td width="20" style="border:solid #000000;border-width:0 1px 1px 0;" align="center">
            单位
        </td>
        <td width="30" style="border:solid #000000;border-width:0 1px 1px 0;" align="center">
            数量
        </td>
        <td width="45" style="border:solid #000000;border-width:0 1px 1px 0;" align="center">
            单价
        </td>
        <?php if ($haveItemDisrate) { ?>
        <td width="20" style="border:solid #000000;border-width:0 1px 1px 0;" align="center">折扣率(%)</td>
        <td width="40" style="border:solid #000000;border-width:0 1px 1px 0;" align="center">
            <?php } else{?>
        <td width="110" style="border:solid #000000;border-width:0 1px 1px 0;" align="center">
            <?php }?>
            金额
        </td>
    </tr>
    ...
    foreach ($list as $arr => $row) {
        if ($row['i'] >= (($t - 1) * $num + 1) && $row['i'] <= $t * $num) {
            ?>
            <tr style="border:solid #000000;border-width:0 1px 1px 0;">
                <td width="30" align="center"><?php echo $row['i'] ?></td>
                <td width="60"
                    style="border:solid #000000;border-width:0 1px 1px 0;word-break:break-all;">
                        <?php echo $row['goods']; ?></td>
                <td width="90" align="center"
                    style="border:solid #000000;border-width:0 1px 1px 0;"><?php echo $row['invSpec'] ?></td>
                ...
                <td width="30" align="right"><?php echo str_money(abs($row['price']), 2) ?></td>
                <?php if ($haveItemDisrate) { ?>
                <td width="20" align="center"><?php echo $row['discountRate'] ?></td>
    ...
    <?php if ($t == $countpage) { ?>
        <tr style="height:20px;">
            <td colspan="6" align="right"
                style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;background-color:LightGrey;">分项合计
            </td>
        ...
        <?php if ($disRate>0) { ?>
            <tr style="height:20px">
                <td colspan="6" align="right"
                    style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;background-color:LightGrey;">总额优惠率
                </td>
                ...
                <?php if ($haveItemDisrate) { ?>
                    <td></td>
                <?php } ?>
                <td width="20" align="center" style="background-color:LightGrey;">支付总额</td>
    ...
    <tr>
        <?php if ($haveItemDisrate) { ?>
        <td colspan="10" style="width:700px;border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;color:red;">
            <?php }else{ ?>
        <td colspan="9" style="width:700px;border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;">
            <?php }?>
            <div style="word-break:break-all;word-wrap:break-word;">
                We order according to conditions and specification above, contracts based on this purchase order shall, unless otherwise agreed by the parties in writing, be subject to 95isee's general purchasing condition printed overleaf, please acknow-ledge this order on enclosed
                form. <br/>
            </div>
            <div style="word-break:break-all;word-wrap:break-word;">
                我们的订单是以上述条件和说明为前提，除非合同双方以书面形式订下条款，合同将受九五尊易订货条款限制，请在附属格式中确认此条款。
            </div>
        </td>
...
<table width="800" style="margin-top:20px;font-size:10px;">
    <tr height="50">
        <td width="200">Seller Signature卖方签字确认:</td>
        <td width="200"></td>
