...
<head>
<title><?php echo $transType==150501 ? '采购入库单' :'采购退货单'?></title>
...
<?php for($t=1; $t<=$countpage; $t++){?>
		<table  width="800"  align="center">
			...
			<tr height="15px">
				<td align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;height:25px;"><?php echo $transType==150501 ? '采购单' :'采购退货单'?></td>
			</tr>
		</table>		
...
<!-- 				<td width="60" >币别：RMB</td> --> 
		...
		<table width="1200" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">
				...
				<tr style="height:20px">
					...
					<td width="80" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">采购单价</td>	
					...
					<td width="60" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">采购金额</td>
					<td width="50" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">币种</td>	
			   ...
			   ?>
				<tr style="height:20px">
				   <td style="border:solid #000000;border-width:0 1px 1px 0;height:15px;font-family:'宋体'; font-size:12px;" align="center"><?php echo $row['i']?></td>
					...
					<td align="right"><?php echo abs($row['price'])?></td>
					<td align="right"><?php echo $row['discountRate']?></td>
					<td align="right"><?php echo str_money(abs($row['deduction']),2)?></td>
				...
				<tr style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;font-family:'宋体'; font-size:12px;">
					...
					<td style="border:solid #000000;border-width:0 1px 1px 0;height:15px;font-family:'宋体'; font-size:12px;" align="center"><?php echo $m?></td>
					<td ></td>
					<td align="center"></td>
					<td align="center"></td>
					<td align="center"></td>
				...
				<tr target="id">
				    <td colspan="10" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;">合计 金额大写： <?php echo str_num2rmb(abs($totalAmount))?> </td> 
				</tr>
				<?php }?>
		</table>
