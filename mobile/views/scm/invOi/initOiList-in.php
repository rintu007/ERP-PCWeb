...
<div class="wrapper">
  <div class="mod-search cf">
    ...
    <div class="fr"><a class="ui-btn ui-btn-sp mrb" id="add">新增</a><a class="ui-btn dn mrb" id="audit"
>审核</a><a class="ui-btn mrb" id="reAudit">反审核</a><a class="ui-btn" id="export" target="_blank">导出</a
></div>
  </div>
  <div class="grid-wrap">
    <table id="grid">
...
<script src="<?php echo base_url()?>/statics/js/dist/otherWarehouseList.js?ver=20171001"></script>
</body>
</html>
