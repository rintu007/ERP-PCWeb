        ...
        <div id="manage-wrap" class="manage-wrap">
            <form id="manage-form" action="">
                <ul class="mod-form-rows base-form cf" id="base-form">
                    ...
                    <li class="row-item">
                        <div class="label-wrap"><label for="currency">采购币种</label></div>
                ...
                <ul class="mod-form-rows">
                    <li class="row-item pb0">
                        <div class="ctn-wrap" style="line-height: normal;"><textarea name="" id="note" class="ui-input ui-input-ph">添加详细说明</textarea></div>
                    </li>
                </ul>
...
<script src="<?php echo base_url()?>statics/js/dist/goodsManage.js?ver=20171015"></script>
