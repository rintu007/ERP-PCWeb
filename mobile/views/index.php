...
<link href="<?php echo base_url()?>statics/css/base.css"
	rel="stylesheet" type="text/css">
<link
	href="<?php echo base_url()?>statics/css/<?php echo sys_skin()?>/default.css?ver=20150522"
	rel="stylesheet" type="text/css" id="defaultFile">
...
var SYSTEM = {
	...
	rights: {"VERIFICA_QUERY":true,"VERIFICA_PRINT":true,"INDEXREPORT_QUERY":true,"PAYMENT_PRINT":true,
		"RECEIPT_PRINT":true,"QTSR_QUERY":true,"QTSR_PRINT":true,"QTZC_QUERY":true,"QTZC_PRINT":true,
		"INVLOCTION_QUERY":true,"PUR_QUERY":true,"CXD_QUERY":true,"CXD_PRINT":true,"ZJZZ_QUERY":true,
		"ZJZZ_PRINT":true,"BACKUP_ADD":true,"BACKUP_RECOVER":true,"ZZD_QUERY":true,"ZZD_PRINT":true,
		"FZSX_QUERY":true,"SettAcctReport_QUERY":true,"SettAcctReport_PRINT":true,"PAYMENTDETAIL_QUERY":true,
		"PAYMENTDETAIL_PRINT":true,"RECEIPTDETAIL_QUERY":true,"PU_QUERY":true,"RECEIPTDETAIL_PRINT":true,
		"PU_PRINT":true,"INVENTORYCLOUD_QUERY":true,"EXPRESS_QUERY":true,"ORDERCLOUD_QUERY":true,
		"ORDERCLOUD_PRINT":true,"SA_QUERY":true,"SA_PRINT":true,"SO_PRINT":true,"CLOUDSTORE_QUERY":true,
		"RECEIPT_QUERY":true,"PO_QUERY":true,"PO_PRINT":true,"DELIVERYADDR_QUERY":true,"CUSTOMERBALANCE_QUERY":true,
		"CUSTOMERBALANCE_PRINT":true,"SUPPLIERBALANCE_QUERY":true,"SUPPLIERBALANCE_PRINT":true,
		"PURCHASEORDER_QUERY":true,"PURCHASEORDER_PRINT":true,"SALESORDER_QUERY":true,"SALESORDER_PRINT":true,
		"SO_QUERY":true,"INVENTORY_PRINT":true,"INVLOCTION_PRINT":true,"BUTYPE_QUERY":true,"SUPPLYTYPE_QUERY":true,
		"TRADETYPE_QUERY":true,"UNIT_QUERY":true,"TF_QUERY":true,"TF_PRINT":true,"IO_QUERY":true,"OPERATE_QUERY":true,
		"SYSTEM_QUERY":true,"BU_QUERY":true,"BU_PRINT":true,"PUR_PRINT":true,"INVENTORY_QUERY":true,"OO_QUERY":true,
		"IO_PRINT":true,"SettAcct_QUERY":true,"Assist_QUERY":true,"PAYMENT_QUERY":true,"OO_PRINT":true,"CADJ_QUERY":true,
		"CADJ_PRINT":true,"SAREPORTDETAIL_QUERY":true,"SAREPORTDETAIL_PRINT":true,"SAREPORTINV_QUERY":true,
		"SAREPORTINV_PRINT":true,"SAREPORTBU_QUERY":true,"SAREPORTBU_PRINT":true,"PUREOORTDETAIL_QUERY":true,
		"PUREOORTDETAIL_PRINT":true,"PUREPORTINV_QUERY":true,"PUREPORTINV_PRINT":true,"PUREPORTPUR_QUERY":true,
		"PUREPORTPUR_PRINT":true,"DeliverDetailReport_QUERY":true,"DeliverDetailReport_PRINT":true,
		"DeliverSummaryReport_QUERY":true,"DeliverSummaryReport_PRINT":true,"InvBalanceReport_QUERY":true,
		"InvBalanceReport_PRINT":true,"ContactDebtReport_QUERY":true,"ContactDebtReport_PRINT":true,"CURRENCY_QUERY":true},//权限列表
...
function getCurrency(){
		Public.ajaxGet('<?php echo site_url()?>/basedata/currency?action=list', {}, function(data){
			if(data.status === 200) {
				SYSTEM.currencyInfo = data.data.items;
			} else if (data.status === 250){
				SYSTEM.currencyInfo = [];
			} else {
				Public.tips({type: 1, content : data.msg});
...
function getPaymentMethod(){
	Public.ajaxGet('<?php echo site_url()?>/basedata/assist?action=list&typeNumber=PayMethod&isDelete=2', {}, 
		function(data){
	 	if(data.status === 200) {
				SYSTEM.paymentMethod = data.data.items;
			} else if (data.status === 250){
...
function getShippingMethod(){
	Public.ajaxGet('<?php echo site_url()?>/basedata/assist?action=list&typeNumber=ShippingMethod&isDelete=2', {}, 
		function(data){
	 	if(data.status === 200) {
				SYSTEM.shippingMethod = data.data.items;
			} else if (data.status === 250){
				SYSTEM.shippingMethod = [];
			} else {
				Public.tips({type: 1, content : data.msg});
			}
	});
...
<body>
	<div id="container" class="cf">
		<div id="col-side">
			<ul id="nav" class="cf">
				<li class="item item-vip"><a href="javascript:void(0);"
					class="vip main-nav">高级<span class="arrow">&gt;</span></a>
				...
				<li class="item item-purchase"><a href="javascript:void(0);"
					class="purchase main-nav">采购<span class="arrow">&gt;</span></a>
					<div class="sub-nav-wrap single-nav">
						<ul class="sub-nav" id="purchase">
						</ul>
					</div></li>
				<li class="item item-sales"><a href="javascript:void(0);"
					class="sales main-nav">销售<span class="arrow">&gt;</span></a>
					<div class="sub-nav-wrap single-nav">
						<ul class="sub-nav" id="sales">
						</ul>
					</div></li>
				<li class="item item-storage"><a href="javascript:void(0);"
					class="storage main-nav">仓库<span class="arrow">&gt;</span></a>
					<div class="sub-nav-wrap single-nav">
						<ul class="sub-nav" id="storage">
						</ul>
					</div></li>
				<li class="item item-money"><a href="javascript:void(0);"
					class="money main-nav">资金<span class="arrow">&gt;</span></a>
					<div class="sub-nav-wrap single-nav">
						<ul class="sub-nav" id="money">
						</ul>
					</div></li>
				<li class="item item-report"><a href="javascript:void(0);"
					class="report main-nav">报表<span class="arrow">&gt;</span></a>
				...
				<li class="item item-setting"><a href="javascript:void(0);"
					class="setting main-nav">设置<span class="arrow">&gt;</span></a>
	...
	<script
		src="<?php echo base_url()?>statics/js/dist/default.js?ver=20171001"></script>
