...
Public.ToCurrencyText = function(a){
	...
	var b = a;
	$.each(parent.parent.SYSTEM.currency,function(key,value){  
		if(value.id==a){					    	
		   	b = value.name;
		   	return true;
	    }					    
...
Public.ToCurrencyIndex = function(a){
	if(a==undefined)return "";
	var ca = parent.parent.SYSTEM.currency;
	if(ca==null)return -1;
...
Public.gotoDetailItem = function(params){
	...
	var urls = {
		//SALE
		'150601' : {tabid : 'sales-sales',text : '销售单',right:'SA_QUERY', url : '/sales/sales.jsp?id='},
		//SALEBACK
