define(["jquery", "print"], function(a) {
	function b() {
		...
		k.beginDate && k.endDate && (i("#selected-period").text(k.beginDate + "至" + k.endDate),
			...
			a.preventDefault(), i("#filter-fromDate").val(k.beginDate), i("#filter-toDate").val(k.endDate),
	...
	var i = a("jquery"),
		...
		l = "../report/puDetail_detailExporter?action=detailExporter",
		m = "../report/puDetail_detail?action=detail";
	a("print"), b(), c(), d();
	var n;
