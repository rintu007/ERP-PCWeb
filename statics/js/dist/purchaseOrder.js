var curRow, curCol, loading, SYSTEM = system = parent.SYSTEM,
    ...
    THISPAGE = {
        init: function (a) {
            this.mod_PageConfig = Public.mod_PageConfig.init("purchaseOrder"),
            SYSTEM.isAdmin !== !1 || SYSTEM.rights.AMOUNT_INAMOUNT || (hiddenAmount = !0, $("#amountArea").hide()),
                this.loadGrid(a),
                this.initDom(a), this.initCombo(), a.id > 0 && a.checked ? this.disableEdit() : (this.editable = !0, $("#grid").jqGrid("setGridParam", {
                cellEdit: !0
        ...
        initDom: function (a) {
            ...
            this.$_customer = $("#customer"),
                ...
                //jason.xie 2017/10/03 add
                this.storageComboAll = Business.storageCombo($("#storage"), {
                    defaultSelected: 0
                });
                ...
                "add" !== a.status || a.buId ? b.customerCombo.selectByValue(a.buId)
                    : Public.ajaxPost("../basedata/contact/getRecentlyContact?action=getRecentlyContact", {
                        ...
                        "" == b.customerCombo.input.val()
                        && (a = a.data, b.customerCombo.selectByValue(a.buId))
            ...
            }), this.classes.setValue(150501 === a.transType ? 0 : 1), a.description && this.$_note.val(a.description),
                this.$_discountRate.val(a.disRate), this.$_deduction.val(a.disAmount), this.$_discount.val(a.amount),
                    this.$_payment.val(a.rpAmount), this.$_arrears.val(a.arrears), requiredMoney && ($("#accountWrap").show(),
            ...
            var c = '<a id="savaAndAdd" class="ui-btn ui-btn-sp">保存并新增</a><a id="save" class="ui-btn">保存</a>',
                ...
                f = "",
                g = "",
                h = "150502" == originalData.transType ? "生成退货单" : "生成采购单",
            ...
            this.btn_edit = d,
                ...
                this.btn_reaudit = g,
                this.btn_turn = i,
                a.id > 0 ? (this.$_number.text(a.billNo),
                        this.$_date.val(a.date),
                        this.$_deliveryDate.val(a.deliveryDate),
                        this.storageComboAll.selectByValue(a.locationId),
                        this.paymentCombo.selectByValue(a.paymentMethod),
                        this.shippingCombo.selectByValue(a.shippingMethod),
                        this.currencyCombo.selectByValue(a.currency),
                        this.$_totalArrears.val(a.totalArrears),
                        this.$_accountInfo.data("accountInfo", a.accounts),
                    -1 === a.accId && (this.$_accountInfo.show(),
                        b.$_payment.attr("disabled", "disabled").addClass("ui-input-dis")),
                        $("#grid").jqGrid("footerData", "set", {
                            qty: a.totalQty,
                            amount: a.totalAmount
                        }), "list" !== urlParam.flag && (j = ""),
                        "edit" === a.status ? this.$_toolBottom.html("<span id=groupBtn>" + d + f + "</span>" + j)
                            : a.checked ? ($("#mark").addClass("has-audit"),
                                this.$_toolBottom.html('<span id="groupBtn">' + i + e + g + "</span>" + j))
                            : this.$_toolBottom.html('<span id="groupBtn">' + e + "</span>" + j),
                        this.idList = parent.cacheList.purchaseOrderId || [],
                    ...
                    this.idPostion === this.idLength - 1 && $("#next").addClass("ui-btn-next-dis"),
                        this.$_userName.html(a.userName), this.$_modifyTime.html(a.modifyTime),
                        this.$_checkName.html(a.checkName))
                    : (this.$_toolBottom.html(billRequiredCheck ? "<span id=groupBtn>" + c + f + "</span>" : '<span id="groupBtn">' + c + "</span>"),
                    ...
                    if (THISPAGE.$_barCodeInsert.hasClass("active")) {
                        var a = function (a) {
                            var b = $("#" + a),
                                c = b.next(),
                                d = b.index() + 1;
                            return 0 == c.length ? ($("#grid").jqGrid("addRowData", THISPAGE.newId, {}, "last"), THISPAGE.newId++, $("#" + (THISPAGE.newId - 1)).index()) :
                                c.data("goodsInfo") ? arguments.callee(d) : d
                        }(THISPAGE.curID);
                ...
                afterEditCell: function (a, b, c, d, e) {
                    if (THISPAGE.curID = a, "goods" === b) {
                        ...
                        if (f) {
                            ...
                            f = $.extend(!0, {}, f), f.skuName = g.skuName, f.mainUnit = g.mainUnit, f.unitId = g.unitId, f.qty = g.qty, f.price = g.price, f.discountRate = g.discountRate, f.deduction = g.deduction, f.amount = g.amount, f.taxRate = g.taxRate, f.tax = g.tax, f.taxAmount = g.taxAmount, f.locationName = g.locationName,
                                $("#" + a).data("goodsInfo", f)
                        }
                    ...
                    if ("price" === b && $("#" + d + "_price", "#grid").val(c), "locationName" === b && ($("#" + d + "_locationName", "#grid").val(c),
                            THISPAGE.storageCombo.selectByText(c)), "mainUnit" === b) {
                ...
                beforeSaveCell: function (a, b, c) {
                    if ("goods" === b) {
                        ...
                        if (!d) {
                            ...
                            THISPAGE.$_barCodeInsert.hasClass("active") ?
        ...
        reloadData: function (a) {
            function b() {
                c.$_customer.data("contactInfo", {
                    ...
                    c.$_storage.val(a.locationName),
                    c.$_number.text(a.billNo),
                    c.classes.setValue(150501 === a.transType ? 0 : 1),
        ...
        enableEdit: function () {
            disEditable || (this.customerCombo.enable(), this.storageComboAll.enable(), this.$_date.removeAttr("disabled").removeClass("ui-input-dis"), this.$_deliveryDate.removeAttr("disabled").removeClass("ui-input-dis"), this.$_note.removeAttr("disabled").removeClass("ui-input-dis"), this.$_discountRate.removeAttr("disabled").removeClass("ui-input-dis"), this.$_deduction.removeAttr("disabled").removeClass("ui-input-dis"), this.$_payment.removeAttr("disabled").removeClass("ui-input-dis"), this.accountCombo.enable(), $("#grid").jqGrid("setGridParam", {
                cellEdit: !0
            }), this.editable = !0)
        },
        ...
        addEvent: function () {
            ...
            this.customerCombo.input.enterKey(), this.$_date.bind("keydown", function (b) {
            ...
            }), this.$_note.enterKey(), this.$_discount.enterKey(), this.$_discountRate.enterKey(),
                ...
                d && ("edit" === originalData.stata && (d.id = originalData.id, d.stata = "edit"),
                    c.ajaxPost("../scm/invPo/add?action=add", {
                ...
                if (b.preventDefault(), Business.verifyRight("PO_UPDATE")) {
                    ...
                    d && c.ajaxPost("../scm/invPo/updateInvPo?action=updateInvPo", {
                        ...
                        200 === b.status ?
                            (a.$_modifyTime.html((new Date).format("yyyy-MM-dd hh:mm:ss")).parent().show(),
                                originalData.id = b.data.id, parent.Public.tips({
                                content: "修改成功！"
                            })) : parent.Public.tips({
                                type: 1,
                                content: b.msg
                ...
                if (b.preventDefault(), Business.verifyRight("PO_CHECK")) {
                    ...
                    d && c.ajaxPost("../scm/invPo/checkInvPo?action=checkInvPo", {
                        ...
                        200 === b.status ? (originalData.id = b.data.id, $("#mark").addClass("has-audit"), $("#edit").hide(), a.$_checkName.html(SYSTEM.realName).parent().show(), a.disableEdit(), $("#groupBtn").html(a.btn_turn + a.btn_view + a.btn_reaudit),
                            $("#turn").html("150502" == originalData.transType ? "生成退货单" : "生成采购单"), parent.Public.tips({
                            content: "审核成功！"
                        })) : parent.Public.tips({
                            type: 1,
                            content: b.msg
                ...
                if (b.preventDefault(), $(this).hasClass("ui-btn-dis")) return void parent.Public.tips({
                    type: 1,
                    content: "该订单已全部入库，不能生成采购单！"
                });
                var c = "采购单",
                    d = "purchase-purchase",
                    e = originalData.transType;
                if ("150502" == e) var c = "采购退货单",
                ...
                return b.preventDefault(), $(this).hasClass("ui-btn-prev-dis") ? (parent.Public.tips({
                    type: 2,
                    content: "已经没有上一张了！"
                }), !1) : (a.idPostion = a.idPostion - 1, 0 === a.idPostion && $(this).addClass("ui-btn-prev-dis"),
                ...
                return b.preventDefault(), $(this).hasClass("ui-btn-next-dis") ? (parent.Public.tips({
                    type: 2,
                    content: "已经没有下一张了！"
                }), !1) : (a.idPostion = a.idPostion + 1, a.idLength === a.idPostion + 1 && $(this).addClass("ui-btn-next-dis"), loading = $.dialog.tips("数据加载中...", 1e3, "loading.gif", !0), Public.ajaxGet("../scm/invPo/update", {
                    id: a.idList[a.idPostion]
                }, function (b) {
        ...
        getPostData: function () {
            ...
            if (this.storageComboAll.getValue() <= 0) {
                parent.Public.tips({
                    type: 2,
                    content: "请选择收货仓库"
                });
            ...
            if (e.length > 0) {
                var f = $.trim(a.$_note.val()),
                    g = {
                        ...
                        locationId: this.storageComboAll.getValue(),
                        ...
                        accId: this.accountCombo.getValue()
                    };
...
$(function () {
    if (urlParam.id) {
        if (!hasLoaded) {
            ...
            Public.ajaxGet("../scm/invPo/update?action=update", {
                id: urlParam.id,
                transType: urlParam.transType ? urlParam.transType : '150501'
            }, function (b) {
