...
function(a) {
		...
		a.ajax({
			...
			success: function(a) {
				if (200 == a.status) {
                    ...
                    $("#realName").val(b.realName);
                    $("#userMobile").val(b.userMobile);
                    $("#email").val(b.email);
				}
			}
		})
	...
	function c() {
		...
		a("#modifyForm").data("onPost", !0), a.ajax({
			url: "../right/queryUserByName?userName=" + b,
			dataType: "json",
			type: "POST",
			success: function(b) {
				c.remove(), a("#modifyForm").data("onPost", !1), 200 == b.status ? (a("#userName").data("valid", !1), h(a("#userName"), !1, "该用户名已被占用")) : (a("#userName").data("valid", !0), h(a("#userName"), !0))
			}
		})
	}
	function d() {
		...
		var b = {
            id:params.id,
            realName: a.trim(a("#realName").val()),
            userName: a.trim(a("#userName").val()),
			userMobile: a.trim(a("#userMobile").val()),
            email: a.trim(a("#email").val()),
		...
		a("#modifyForm").data("onPost", !0), a.ajax({
			...
			dataType: "json",
			success: function(c) {
				a("#modifyForm").data("onPost", !1), 200 == c.status ?
					(Public.tips({
                        type: 0,
                        content: c.msg
                    }),window.location.href = "authority"): Public.tips({
					type: 1,
					content: c.msg
				})
			},
			error: function() {
				a("#modifyForm").data("onPost", !1), Public.tips({
					type: 1,
					content: "编辑用户失败！请重试"
				})
			}
	...
	function f(a) {
		for (var b = a.find("input:visible"), c = !0, d = 0, e = b.length; e > d; d++) {
			var f = b.eq(d);
			"undefined" != typeof f.data("valid") ? f.data("valid")
				|| (c = !1, f.addClass("input-error")) : g(f) || (c = !1);
			if(c==false){
				break;
			}
		}
	...
	a("#modifyForm input").on("focus", function() {
		a(this).parent().find(".msg").addClass("msg-focus"), i(a(this)),
		"password" == a(this).attr("id") && a("#pswStrength").show()
	}).on("blur", function() {
		"undefined" == typeof a(this).data("valid") ? (g(a(this)), "userName" == a(this).attr("id") && a(this).data("valid")
		&& (a(this).removeData("valid"), i(a(this)), c())) : (a(this).data("valid") === !1
		&& a(this).addClass("input-error"), a(this).parent().find(".valid-msg").show()),
			a(this).parent().find(".msg").removeClass("msg-focus"),
		"password" == a(this).attr("id") && a("#pswStrength").hide()
	}).on("change", function() {
		a(this).removeData("valid")
	}),
		a("#modifyBtn").on("click", function(b) {
		b.preventDefault(), f(a("#modifyForm")) && !a("#modifyForm").data("onPost") && d()
	}),
