			...
			if (f.length > 0) {
				var g = $.trim(b.$_note.val()),
					h = {
						...
						staffName: b.salesCombo.getText(),
...
$(function() {
	if (urlParam.id) {
		...
		accId: 0,
		customerFree: "0.00"
	}, "150602" == urlParam.transType ? originalData.transType = "150602" : originalData.transType = "150601",
