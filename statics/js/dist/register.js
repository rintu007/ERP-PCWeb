!
    function (a) {
        ...
        function d() {
            ...
            a("#registerForm").data("onPost", !0), a.ajax({
                ...
                dataType: "json",
                success: function (c) {
                    a("#registerForm").data("onPost", !1),
                        200 == c.status ?
                            window.location.href = "authority_setting?userName=" + b.userName + "&right=0" :
                            Public.tips({
                                type: 1,
                                content: c.msg
                            })
    ...
    //合起来就是
    //(?!^\\d+$)(?!^[a-zA-Z]+$)(?!^[_#@]+$).{8,}
                password:/^[a-zA-Z]{1}([a-zA-Z0-9]|[._]){5,19}$/,
        ...
        a("#registerForm input").on("focus", function () {
            ...
            "undefined" == typeof a(this).data("valid") ? (g(a(this)),
                "userName" == a(this).attr("id") && a(this).data("valid")
                && (a(this).removeData("valid"), i(a(this)), c())) :
                (a(this).data("valid") === !1 && a(this).addClass("input-error"),
                    a(this).parent().find(".valid-msg").show()),
