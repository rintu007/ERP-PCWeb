var curRow, curCol, loading, SYSTEM = system = parent.SYSTEM,
	...
	THISPAGE = {
		init: function(a) {
			this.mod_PageConfig = Public.mod_PageConfig.init("150502" == urlParam.transType ? "purchaseBack" : "purchase"),
		...
		initDom: function(a) {
			...
			"150502" == originalData.transType ? (parent.$("#page-tab").find("li.l-selected").children("a").html("采购退货单"), $("#paymentTxt").html("本次退款")) : (parent.$("#page-tab").find("li.l-selected").children("a").html("采购入库单"), $("#paymentTxt").html("本次付款"));
			...
			this.$_arrears.val(a.arrears), requiredMoney && ($("#accountWrap").show(), 
		...
		loadGrid: function(a) {
			...
			},			
			{
				...
				formatter: function(a) {
					return Public.ToCurrencyCode(a);
				}
			}
			];
				...
				afterEditCell: function(a, b, c, d, e) {
					function f() {
						...
						if (b) {
							...
							b = $.extend(!0, {}, b), b.mainUnit = c.mainUnit,b.currency = c.currency, b.unitId = c.unitId, b.qty = c.qty, b.price = c.price, b.discountRate = c.discountRate, b.deduction = c.deduction, b.amount = c.amount, b.taxRate = c.taxRate, b.tax = c.tax, b.taxAmount = c.taxAmount, b.locationName = c.locationName, $("#" + a).data("goodsInfo", b)
						}
					}
				...
				if ("" !== h.goods) {
					...
					if (i) {
						...
						f = {
							...
							srcEntryId: h.srcEntryId,
							srcId: h.srcId,
							srcBillNo: h.srcBillNo,
							serNumList: l
