...
function BBSPop() {
    var a = $("#yswb-tab"),
        b = ['<ul id="yswbPop">', '<li class="yswbPop-title">请选择您要进入的论坛</li>', '<li><strong>产品服务论坛</strong><p>在线会计，在线进销存操作问题咨询</p><a href="http://wpa.qq.com/msgrd?V=3&uin=210025670&Site=小阳&Menu=yes" target="_blank">进入论坛>></a></li>', '<li><strong>会计交流论坛</strong><p>会计实操，会计学习，会计资讯</p><a href="http://wpa.qq.com/msgrd?V=3&uin=210025670&Site=小阳&Menu=yes" target="_blank">进入论坛>></a></li>', "</ul>"].join("");
...
var dataReflush, list = {
        ...
        purchaseBack: {
            name: "采购退货单",
            href: "../scm/invPo?action=initPo&transType=150502",
            dataRight: "PO_ADD",
            target: "purchase",
            list: "../scm/invPo?action=initPoList&transType=150502"
        },
        salesQuotation: {
            name: "销售报价单",
            href: "../scm/invSo?action=initSo&transType=150603",
            dataRight: "SQ_ADD",
            target: "sales",
            list: "../scm/invSo?action=initSoList&transType=150603"
        },
        salesOrder: {
            name: "销售订单",
        ...
        salesBack: {
            name: "销售退货单",
            href: "../scm/invSo?action=initSo&transType=150602",
            dataRight: "SA_ADD",
            target: "sales",
            list: "../scm/invSo?action=initSoList&transType=150602"
        },
        transfers: {
            name: "调拨单",
        ...
        purchaseWarehouse: {
            name: "采购入库",
            href: "../scm/invPw?action=initPw",
            dataRight: "PW_ADD",
            target: "storage",
            list: "../scm/invPw?action=initPwList"
        },
        sales: {
            name: "销售出库",
            href: "../scm/invSd?action=initSd",
            dataRight: "SA_ADD",
            target: "storage",
            list: "../scm/invSd?action=initSdList"
        },
        otherWarehouse: {
            name: "其他入库单",
...
//	},
        ...
        currencyList: {
            name: "币种资料",
            href: "../settings/currency_list",
            dataRight: "CURRENCY_QUERY",
            target: "setting-auxiliary"
        },
        assistingProp: {
            name: "辅助属性",
    ...
    menu = {
        ...
        _menuControl: function () {
            ...
            switch (this._hide(["authority", "backup", "onlineStoreMap", "onlineStoreList", "onlineStoreRelation", "logisticsList", "orderHandle1", "orderHandle2", "orderHandle3", "orderList", "onlineSalesList", "JDStorageList", "JDStorageGoodsList", "JDStoragePurchaseOrderList", "JDStorageSaleOrderList", "JDStorageInvManage", "assistingProp", "serNumStatus", "serNumTracer"]), a) {
                ...
                case 1:
                    //jason.xie 2017/10/02
                    this._hide([/*"purchaseOrder", "purchaseOrderList", "salesOrder", "salesOrderList", "puOrderTracking", "salesOrderTracking",*/"verification", "verificationList", "shippingAddress", "assemble", "disassemble", "serNumStatus", "serNumTracer"]);
                    break;
                case 2:
            }
            switch (c) {
...
$("#nav").on("click", "[rel=pageTab]", function (a) {
    ...
    if (2 === SYSTEM.siVersion && SYSTEM.isOpen) {
        var b, c = location.protocol + "//" + location.host + "/update_info.jsp",
            d = '您的单据分录已经录入达到300条，继续使用选择<a href="http://wpa.qq.com/msgrd?V=3&uin=210025670&Site=小阳&Menu=yes" target="_blank">购买产品</a>或者完善个人信息赠送1000条免费容量。';
        SYSTEM.isshortUser ? SYSTEM.isshortUser && (b = "http://wpa.qq.com/msgrd?V=3&uin=210025670&Site=小阳&Menu=yes&updateUrl=" + encodeURIComponent(c) + "&warning=" + encodeURIComponent(d) + "&loginPage=http://wpa.qq.com/msgrd?V=3&uin=210025670&Site=小阳&Menu=yes&", a.dialog({
            min: !1,
            max: !1,
            cancle: !1,
            lock: !0,
            ...
            title: "完善个人信息",
            content: "url:" + b
        })) : (b = "http://wpa.qq.com/msgrd?V=3&uin=210025670&Site=小阳&Menu=yes&updateUrl=" + encodeURIComponent(c) + "&warning=" + encodeURIComponent(d), a.dialog({
            min: !1,
            max: !1,
            cancle: !1,
            lock: !0,
    ...
    if ($("#scollUp").click(function () {
        ...
        var c = [{
                ...
                focus: !0,
                callback: function () {
                    window.open("http://wpa.qq.com/msgrd?V=3&uin=210025670&Site=小阳&Menu=yes&zh-CHS&accIds=" + SYSTEM.DBID)
                }
            }, {
                name: "下次再说"
            }],
